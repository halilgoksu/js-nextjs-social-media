...
export default function Dashboard() {
  ...
  return (
    <container  className="h-screen w-full flex flex-col items-center  text-center text-purple-900 p-2">
<div className="h-screen w-full flex flex-col items-center  text-center text-purple-900 p-2">
