        ...
        <div className="w-full  p-2">
          <div className="flex gap-1 ">
            <input
              ...
              className=" w-5 p-2 text-white text-sm  btn btn-blue-500 bg-gray-800 hover:bg-gray-900 first-letter 
             font-bold py-2 px-4 rounded "
            />
            <button
              onClick={submitMessage}
              className=" first-letter  py-2 px-4 rounded text-white bg-gray-900 text-sm w-fit"
            >
              Submit
            </button>
          </div>
