...
export default function Login() {
  ...
  the user in with their Google account, and then redirecting them to the homepage ("/") using the route.push method. The auth variable is likely a reference to the Firebase 
