...
export default function Nav() {
  ...
  return (
    <nav className="flex justify-between items-center  bg-indigo-900 p-4">
      <Link href="/">
        <div
          className="cursor-pointer flex-col items-center justify-around  text-center p-2 bg-purple-800 m-2
        rounded-lg
        "
        >
      ...
      <div
        className=" flex-col items-center justify-around  text-center p-2 m-2
        rounded-lg">
      ...
      <div className="flex items-center">
        ...
        {user && (
          <div className="cursor-pointer flex-row items-center justify-around  text-center p-2 bg-purple-800 m-2
          rounded-lg
          "
          >
            <Link href="/post">
