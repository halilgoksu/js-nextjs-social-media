...
export default function Nav() {
  ...
  return (
    <nav className="flex  flex-col justify-center items-center  bg-indigo-900  text-white w-full h-full border-2 border-black">
      <div className="flex border-2 py-4 gap-5">
        <Link href="/">
          <div
