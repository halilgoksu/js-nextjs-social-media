...
export default function Nav() {
  ...
  return (
    <nav className="flex justify-between  items-center  py-10 bg-blue-900 w-1 ">
      <Link href="/" title="asdfasdf">
        <a
          className="bg-white btn btn-blue-500 hover:bg-blue-100 gap-2 text-center justify-center items-center
