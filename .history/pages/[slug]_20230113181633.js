        ...
        <div className="w-full border-2 border-yellow-500 p-2">
          <div className="flex gap-1 ">
            ...
            <button
              ...
              className=" border-2 first-letter  py-2 px-4 rounded text-white bg-black"
            >
              Submit
            </button>
          </div>
          <div className="py-6">
            ...
            {allMessage?.map((message) => (
              <div
                className="bg-pink-300 p-4 my-4 border-2 rounded-lg"
                key={message.time}
              >
                <div className="flex items-center gap-2 mb-4 bg-purple-900">
                  <img
