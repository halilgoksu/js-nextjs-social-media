...
export default function Post() {
  ...
  return (
    <container className="flex  flex-col justify-center items-center w-full h-fit py-2 border-2">
        ...
        border-2 ">
          ...
          <div className=" fpy-2 w-full h-fit ">
            <textarea
              maxLength="100"
              ...
              className= "bg-purple-800  text-white rounded-lg p-2 text-xs w-60 h-40 resize-none "
            ></textarea>
            <p
