...
export default function Nav() {
  ...
  return (
    <nav className="flex justify-between items-center py-10 bg-red-900 ">
      <Link href="/">
        <h1 className="flex content-center justify-around w-4  text-xl border-4 border-black  font-medium rounded-sm  bg-white font-large gap-2 "><BsFillPenFill className=""/> Poet</h1>
      </Link>
