...
export default function Nav() {
  ...
  return (
    <nav className="flex   justify-center items-center  bg-indigo-900 py-4 text-white ">
      <div className="flex flex-col justify-around items-center gap-4 max-w-xl ">
        <Link href="/">
          <div
      ...
      <div className="empowerdown items-center  text-center  hidden">
