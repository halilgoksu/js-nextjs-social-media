...
export default function Nav() {
  ...
  return (
    <nav className="flex  flex-col justify-center items-center  bg-indigo-900 py-4 text-white ">
      <div className="flex  justify-around items-center gap-4 max-w-xl min-w-xl">
        <Link href="/">
          <div
