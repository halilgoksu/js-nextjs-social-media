...
export default function Post() {
  ...
  return (
    <container className="flex  flex-col justify-center items-center w-full h-fit py-2 border-2">
      <form
        onSubmit={submitPost}
        className="w-2/3 max-w-lg  p-2 flex felx-col items-center justify-center text-center 
        border-2 "
      >
        ...
        <textarea
          ...
          className="bg-purple-800  text-white rounded-lg p-2 text-xs resize-none w-full h-60"
        ></textarea>
        <p
