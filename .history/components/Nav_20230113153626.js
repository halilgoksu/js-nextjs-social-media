...
export default function Nav() {
  ...
  return (
    <nav className="flex  flex-col justify-center items-center  bg-indigo-900  text-white w-full border-2 border-black">
      <div className="flex border-2 py-4 justify-around">
        <Link href="/">
          <div
       ...
       direk href in icine yaz o hallder */}
        <div className="empowering items-center  text-center p-2 m-2 ">
      ...
      <div className="empowerdown items-center  text-center p-2 hidden">
