...
export default function Nav() {
  ...
  <div className="cursor-pointer flex-col items-center justify-around  text-center p-2 m-2
        rounded-lg
        ">      <p className="text-xs font-serif italic font-thin">Empowering voices, fostering understanding.</p>
      </div>
