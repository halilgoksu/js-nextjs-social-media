    ...
    <container className="flex  flex-col justify-center items-center w-full h-fit p-4 border-2">
      ...
      >
        ...
        <textarea
          ...
          className="bg-purple-800  text-white rounded-lg p-2 text-xs resize-none w-full h-40"
        ></textarea>
        <p
        ...
        <button
          type="submit"
          className=" bg-purple-900 text-white font-medium p-2 my-2 rounded-lg text-xs"
        >
          Submit
        </button>
      </form>
