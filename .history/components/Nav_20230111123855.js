    ...
    <nav className="flex justify-between items-center  bg-indigo-900 p-4 border-2 ">
      ...
      <div className="flex items-center">
        ...
        {user && (
          ...
          >
            <Link href="/post">
             <div className="cursor-pointer flex flex-col items-center text-center p-1  m-2 rounded-lg ">
               <BsFillPenFill className="text-4xl p-1" />
               <h6 className="font-serif text-xs italic font-thin">Post</h6>
              </div>
            </Link>

            <Link href="/dashboard">
               <div className="cursor-pointer flex flex-col items-center text-center p-1  m-2 rounded-lg ">
                  <img className="h-fit" src={user.photoURL} />
                  <h6 className="font-serif text-xs italic font-thin">Post</h6>
              </div>
            </Link>
          </div>
