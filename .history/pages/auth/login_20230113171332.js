...
export default function Login() {
  ...
  <container className="flex  flex-col justify-center items-center w-full h-fit py-8 border-2 shadow-lg">
    <div  className="w-2/3 max-w-lg  p-2  items-center justify-center text-center 
        border-2 ">
    <h2 className="text-2xl font-medium">Join Today</h2>
      <div className="py-4 m-1">
        ...
        <button
          onClick={GoogleLogin}
          className="text-white bg-gray-700 w-f font-medium rounded-lg flex align-middle p-4 gap-2
          text-center "
        >
