...
export default function Post() {
  ...
  return (
    <container className="flex  flex-col justify-center items-center w-full h-fit p-4 ">
      <form
        onSubmit={submitPost}
        className="w-2/3 max-w-lg  p-2  items-center justify-center text-center  flex-col
      ...
      >
        ...
        <textarea 
         className="bg-purple-800  text-white rounded-lg  text-xs resize-none w-60 h-40 
         border-2  border-purple-900 flex "
          maxLength="100"
