...
export default function Layout({ children }) {
  return (
    <div className="w-screen h-full  bg-indigo-200 items-center justify-center text-center ">
      <Nav/>
      <main className="flex  h-full w-2/3  border-4 bg-indigo-400 justify-center items-center text-center">
        {children}</main>
