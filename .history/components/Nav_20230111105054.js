  ...
  return (
    <nav className="flex justify-between  items-center  py-10 bg-blue-900 w-1/2 ">
      <Link href="/" title="asdfasdf">
        <div className="cursor-pointer flex-col items-center justify-around  text-center p-4 bg-orange-300 m-2">
          <GiAllSeeingEye className="text-5xl inline"/>
          <p className="text-xs font-serif italic font">tell me a secret</p>
        </div>
      </Link>
