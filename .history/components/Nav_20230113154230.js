...
export default function Nav() {
  ...
  return (
    <nav className="flex  flex-col justify-center items-center  bg-indigo-900  text-white w-full">
      <div className="flex py-4 gap-5">
       ...
       direk href in icine yaz o hallder */}
        <div className="empowering items-center  text-center p-2 m-2 ">
          <p className="text-xs font-serif italic font-thin text-purple-400 text">
