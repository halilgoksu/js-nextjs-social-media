...
export default function Details() {
  ...
  return (
    <container className="w-screen h-screen flex felx-col items-center justify-center text-center">
      <div className="w-screen h-screen flex felx-col items-center justify-center text-center">
