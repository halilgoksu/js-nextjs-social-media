...
export default function Nav() {
  ...
  return (
    <nav className="flex flex-col justify-between items-center  bg-indigo-900 p-4 border-2 w-full h-full">
      <div className="flex justify-between items-center  bg-indigo-900 p-4 border-2 w-full h-full">
      <Link href="/">
     ...
     <div
        className="empowerdown items-center  text-center p-2 m-2 hidden"
      >
        <p className=" text-xs font-serif italic font-thin">
          Empowering voices, fostering understanding.
        </p>
