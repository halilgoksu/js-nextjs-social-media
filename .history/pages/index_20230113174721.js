...
export default function Home() {
  ...
  return (
    <container className="flex  flex-col justify-center items-center w-full  border-2 shadow-lg border-green-900">
    <Head>
        <title>Posti</title>
      ...
      <div  className="w-2/3 max-w-lg  p-3 flex flex-col items-center text-center border-2
       border-red-700 gap-4 h-full overflow-hidden">
        {allPosts.map((post) => (
