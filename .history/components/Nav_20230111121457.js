...
export default function Nav() {
  ...
  return (
    <nav className="flex justify-between items-center  bg-indigo-900 p-4 border-2 ">
      <Link href="/">
        <div
          className="cursor-pointer f flex-col items-center text-center p-2 bg-purple-800 m-2
        rounded-lg h-14
        "
        >
          <GiAllSeeingEye className="inline h-full" />
          <p className="inline h-full  font-serif italic font-thin">InsightStream</p>
        </div>
      </Link>
