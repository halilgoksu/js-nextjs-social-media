...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center text-center mt-3 text-gray-900 text-xs border-2 w-fit '>
         Created by <a className='cursor-pointer' border-2  title='Go' href="https://www.halilgoksu.com">©Goksu</a>
      </div>
