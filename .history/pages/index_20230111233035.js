...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className='  justify-center items-center text-center mt-3 text-gray-900 text-xs '>
         Created by <a className='cursor-pointer' border-2 border-black title='Go' href="https://www.halilgoksu.com">©Goksu</a>
      </div>
