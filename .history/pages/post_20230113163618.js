...
export default function Post() {
  ...
  return (
    <container className="border-2 flex justify-center text-center items-center w-full h-fit p-8">
        <form onSubmit={submitPost} className="w-2/3 max-w-lg  p-2 felx justify-center text-center text-center">
          ...
          <div className="py-2">
            <textarea
              ...
              className= "bg-purple-800  text-white rounded-lg p-2 text-xs w-60 h-60 resize-none "
            ></textarea>
            <p
